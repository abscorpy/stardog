...
class MachineGun(Cannon):
	...
	shootPoint = -14, 0;range = 1;speed = 600;name = 'Machine Gun'; value = 1.5
...
class LeftLaser(Laser, FlippablePart):
	...
	shootPoint = 0, - 15; shootDir = 270;	name = "Left Laser"	; value = 1.5
class RightLaser(Laser, FlippablePart):
	baseImage = loadImage("res/parts/rightlaser" + ext)
	shootPoint = 0, 15;	shootDir = 90;	name = "Right Laser"; value = 1.5
...
class EmergencyEngine(Engine):	
	...
	energyCost = .2; value = .1; hp = 3
class TakeOffEngine(Engine):
	name = "Take-Off Engine";	force = 40000;	thrusting = False
	energyCost = 3; value = .8; hp = 3
